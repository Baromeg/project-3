...
const SingleLocation = (props) => {
  ...
  useEffect(() => {
    axios.get(`/api/locations/${locationId}`).then((resp) => {
  ...
  function handleComment(event) {
    ...
    axios
      .post(`/api/locations/${locationId}/comments`, formData, {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((resp) => {
        if (resp.data.errors) {
  ...
  function handleDeleteComment(commentId) {
    axios
      .delete(`/api/locations/${locationId}/comments/${commentId}`, {
        headers: { Authorization: `Bearer ${token}` }
      })
      .then((resp) => {
        updateLocation(resp.data)
          ...
          <article className='tile is-child box is-centered'>
            <div className='columns is-mobile'>
              ...
              <div className='column is-9 pb-0 pt-0 is-mobile'>
                <h1 className='title is-1 is-primary is-capitalized mb-0'>
                  {location.name}
                </h1>
              ...
              <div className='column is-2 pb-0 is-hidden-mobile'>
                {isCreator(location.user) && (
                  <div className='dropdown is-hoverable is-right is-mobile'>
              ...
              <div className='column is-1 pb-0'>
                {location.website && (
                  <div className='is-right is-mobile'>
                    <a
            ...
            <article className='tile is-child box'>
              <div className='columns'>
                ...
                <div className='column'>
                  ...
                  <p className='content is-capitalized mb-0'>
                    {location.timings}
                  </p>
                </div>
              </div>
        ...
        <div className='tile is-parent '>
          <article className='tile is-child box is-centered'>
            <div className='columns'>
              ...
              <div className='column'>
                {location.latitude && (
                  <div className='columns is-centered m-1 is-mobile'>
                  ...
                  return (
                    <div key={comment._id} className='media'>
                      ...
                      {isCreator(comment.user._id) && (
                        <div className='media-right is-justify-content-center'>
                          <Link
                            to={`/locations/edit-comment/${locationId}/${comment._id}`}
                            className='edit mr-1'
                          >
            ...
            {localStorage.getItem('token') &&
              !location.comments.some((comment) => {
                ...
                <div className='media'>
                  ...
                  <div className='media-content'>
                    <div className='field'>
                      <form className='control' onSubmit={handleComment}>
                        <Rater
                          total={5}
                          onRate={setRating}
                          className='react-rater'
                        ...
                        <div className='field'>
                          <p className='control'>
                            <button className='button is-link  my-1'>
                              Submit
                            </button>
                          </p>
                        </div>
