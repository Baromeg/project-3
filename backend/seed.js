...
mongoose.connect(
  ...
  (err) => {
    ...
    mongoose.connection.db
      .dropDatabase() // ! reset the data, remove whats there
      .then(() => {
        return User.create([
          {
            username: 'flow',
          ...
          },
          {
            ...
            city: 'london',
            avatar:
              'https://pbs.twimg.com/profile_images/2624763257/lz5pautt5yimot9nwqow.png'
          }
        ])
      })
      .then((users) => {
        ...
        const seedData = [
          {
            ...
            endDate: '',
            address:
              'First Floor, Hopkinson Art, Vintage & Antiques Store, 21 Station Street, Nottingham',
            city: 'Nottingham',
            postcode: 'NG2 3AJ',
            longitude: '',
            latitude: '',
            ...
            phone: '07958 365155',
            bio:
              'We are a vegan food delivery service providing great quality and wholesome vegan, gluten free food and plastic free options in Nottingham and the surrounding area through VDelivery and throughout the UK on this site.',
            image:
              'https://www.dashvegan.co.uk/wp-content/uploads/2018/03/Dash-Vegan-logo-upper-padding.png',
            user: users[0]
          },
          {
            category: ['Sustainable Groceries'],
            ...
            endDate: '',
            address:
              'Shop Zero, Front Shop, Malt Cross, 16 St James Street, Nottingham',
            city: 'Nottingham',
            postcode: 'NG1 6FG',
            longitude: '',
            latitude: '',
            ...
            phone: '',
            bio:
              'We are here to help you shop more consciously and reduce your environmental impact. Bring your own containers for bulk, unpackaged food, lower impact personal care, on the-go items, sustainable household goods and gifts.',
          ...
          },
          {
            ...
            endDate: '',
            address:
              'University of Manchester Students Union, Oxford Road, Manchester',
            city: 'Manchester',
            postcode: 'M13 9PR',
            longitude: '',
            latitude: '',
          ...
          },
          {
            ...
            name: 'By The Gram',
            timings:
              'Mon-Closed, Tues-Closed, Wed-9.30am-5.00pm, Thur -9.30am-5.00pm, Fri -9.30am -5 .00pm, Sat -10.00am-5.00pm, Sun -10.00am-4.00pm',
            startDate: '',
            endDate: '',
            ...
            phone: '07913318832',
            bio:
              'We are a single use plastic free zero waste shop. You can buy as much or as little as you need and you only pay by weight for the loose items and refills. We stock a range of products from whole foods to refill liquids to personal household items.',
          ...
          },
          {
            ...
            phone: '07792502180',
            bio:
              'We use the finest ingredients to ensure our produce is sustainable and delicious.',
            image:
              'https://www.thezerowastenetwork.com/pictures/profile/pimage-185-469-photo.jpg',
            user: users[0]
          },
          {
            category: ['Sustainable Groceries'],
            ...
            timings:
              'Sunday - Closed, Monday - Closed, Tuesday - 10 - 6.30, Wednesday - 10 - 5.30, Thursday - 10 - 7, Friday - 10 - 5.30, Saturday - 9.30 - 5',
            startDate: '',
            endDate: '',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'Wonderful Farmers Market that attracts sellers from all around the local countryside.',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'Whatever produce you are looking for, we have it here. From locally grown vegetables to fresh eggs, this is the place to shop sustainably.',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'A delightful market that will give you all the fresh food you could want.',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'All of the local farmers help to make this a delightful market. Yum yum yum!',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'Romsey farmers market is a beautiful place to shop fresh produce - especially when Terry turns off his diesel generator.',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'The best local farmers market in Hampshire. Fresh food and fresh people!',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'When in Winchester come to the market and enjoy the wonderful food that is available for you to buy. Go local, Go Winchester!',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'Wellington Farm Shop opens daily and stocks a range of fresh meat such as lamb, pork, poultry, sausages and game. You ll find all of this as well as fruit and veg, local bread and fresh cakes.',
          ...
          },
          {
            ...
            timings:
              'Monday - Friday 8:30am - 5:30pm, Saturday 8:00am - 3:00pm, Sunday 9:00am - 2:30pm',
            startDate: '',
            endDate: '',
            ...
            phone: '',
            bio:
              'Newlyns stock their own home-produced meat as well as offering items such as fresh fruit and vegetables, not forgetting the delicatessen counters full of goodies',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'As well as a good offering of local meat and dairy produce Durleighmarsh also grow their own fruit and vegetables which are all ready-picked in season.',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'With a farm shop, cafe and butchery on site, Cobbs certainly have all the bases covered when it comes to food and drink. Having been in the heart of the local community for more than thirty years they pride themselves in serving up quality food with provenance.',
          ...
          },
          {
            ...
            bio:
              'Winner of Best Farm Shop at the 2013 and 2014 Hampshire Life Food and Drink Awards, Beechcroft offer fresh cuts of lamb, beef and pork, as well as turkey at Christmas. All the animals are free range and left to slowly mature on Beechcrofts chalkland fields.',
          ...
          },
          {
            ...
            timings:
              'Mon-Weds 9.30am to 4pm, Friday and Saturday 10.00am to 5pm',
            startDate: '',
            endDate: '',
            ...
            phone: '',
            bio:
              'Whether you re new to reducing your environmental impact, or a hard-core eco warrior All Good Things is the perfect shop for you. We have packaging-free and zero waste alternatives for many of your regular household purchases.',
          ...
          },
          {
            ...
            timings:
              'Tue-Fri 10.00am to 5.00pm, Sat 9.00am to 5.30pm, Sun 10.00am to 4.00pm',
            ...
            phone: '',
            bio:
              'We specialise in plastic-free, organic and low waste products. You can bring your own containers to the store to stock up on food staples such as grains beans pasta and cereals.',
          ...
          },
          {
            ...
            timings:
              'Mon, Tue, Thur & Friday – 10am to 12pm, Saturday 10:30am - 12:30pm',
            ...
            phone: '02392 528 096',
            bio:
              'We stock over 280 loose food products, plastic free and ethical our aim is to sell 95% Organic food by the end of 2020.',
          ...
          },
          {
            ...
            phone: '01962 844 001',
            bio:
              'There is plenty to choose from on our vegan and vegetarian menu at ONeills Winchester. So, whether you are in for breakfast, a quick bite at lunchtime, or to share some tapas with your mates, we have got something delicious and nutritious especially for you.',
          ...
          },
          {
            ...
            phone: '',
            bio:
              'We take popular classic dishes, pull them apart, throw the rule book away and remodel those dishes into something new, exciting and mind blowing.',
          ...
          },
          {
            ...
            phone: '0300 777 1635',
            bio:
              'Our charity shops sell a mixture of donated clothes, books, toys, household goods and soft furnishings.',
          ...
          },
          {
            ...
            phone: '01252 628 575',
            bio:
              'Welcome to Pedal Heaven. Hampshire s most innovative and modern bicycle experience destination.',
          ...
          },
          {
            ...
            phone: '01252 723888',
            bio:
              'East Street Cycles journey began long before our doors opened in the Summer of 2004. At the start it was myself and one full time employee and a bit of a rota on Saturdays cajoling friends into helping out…',
          ...
          },
          {
            ...
            email: '',
            timings:
              'Open Monday to Saturday from 8am to 9pm, Sundays from 9am to 9pm',
            latitude: 51.53788,
            longitude: -0.09946,
            bio:
              'The UKs largest fully certified organic supermarket, Planet Organic are getting in on the zero waste act.Four of its stores now offer the Unpackaged zero waste way of buying legumes, grains, dry goods and so on with your own containers.Find them in Muswell Hill, Westbourne Grove, Islington and Torrington Place.',
            image:
              'https://www.naturalproductsonline.co.uk/wp-content/uploads/2017/11/Planet-Organic-800x506.jpg',
            user: users[0]
          }
        ]
        const newData = []
          ...
          newData.push(
            new Promise((resolve) => {
              setTimeout(() => {
                axios
                  .get(
                    `https://api.mapbox.com/geocoding/v5/mapbox.places/${seedData[i].postcode}.json?access_token=${process.env.MapBoxKey}`
                  )
                  .then((resp) => {
                    const location = {
                      ...seedData[i],
          ...
          rawYelpData.push(
            new Promise((resolve) => {
              setTimeout(() => {
                axios
                  .get(
                    `https://api.yelp.com/v3/businesses/search?location=UK&limit=${limit}&offset=${
                      limit * i
                    }&categories=vegan,farmersmarket,vegetarian,salad,bikerepair,bikeshop,organic_stores,ethicgrocery,bike_repair_maintenance,electronicsrepair,furniturerepair,shoerepair,evchargingstations,vintage,fleamarkets`,
                    {
                      headers: {
      ...
      .then((rawYelpData) => {
        ...
        rawYelpData.forEach((array) => {
          array.map((item) => {
            ...
            const yelpAlias = categoryAliasesArray.filter((e) =>
              yelpCatArray.includes(e)
            )[0]
